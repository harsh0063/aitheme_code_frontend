...
function HomePage() {
  ...
  const { data: themes } =useGetThemesQuery({ is_free: 'True' })
;
  ...
  return (
    <>
      <Helmet>
        <title>
          {
            subcategory__name?.name && category__name?.name
              ...
              : category_name
                ...
                : 'Free Website Themes & Templates – WordPress, HTML, Bootstrap, Shopify, PHP, Laravel | AIThemeCode'
          } 
        </title>

        <meta name="keywords" xml:lang="en" lang="en" content={`Free Themes `} />
        <meta name="description" xml:lang="en" lang="en" content={` "Free  Browse AIThemeCode’s wide range of premium website themes and templates. WordPress, HTML, and Bootstrap designs crafted for blogs, businesses, and portfolios."}`} />
        <meta name="og:description" content={` " Free Browse AIThemeCode’s wide range of premium website themes and templates. WordPress, HTML, and Bootstrap designs crafted for blogs, businesses, and portfolios."}`} />
        ...
        <meta name="twitter:description" content={` "Free Browse AIThemeCode’s wide range of premium website themes and templates. WordPress, HTML, and Bootstrap designs crafted for blogs, businesses, and portfolios."}`} />
          ...
          <div className="flex justify-center  mb-[30px] items-center gap-[10px]">
            <Link to={'/'} className="pop max-sm:text-sm text-[#333333]"> Home</Link>
              ...
              <div className="flex max-sm:text-sm items-center gap-[10px]">
                ...
                <div className="capitalize pop max-sm:text-sm text-[#90A4AE]">Free Download</div>
              </div>
           
          </div>

          <h1 className="pop font-[600] leading-[54px] mb-[10px] max-md:text-[35px] max-sm:text-[26px] max-sm:leading-[35px] text-center text-[40px] capitalize"> Free Download</h1>

          <p className="text-[20px] leading-[54px] max-lg:leading-[35px] max-sm:leading-[30px] max-sm:text-[18px] text-center">2025’s Premium Free  Themes from Ai Theme Code</p>
