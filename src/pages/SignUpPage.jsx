...
import { useRegisterUserMutation } from '../service/apislice';
    ...
    return (
        <section className="min-h-screen flex items-center justify-center px-4 bg-blue-50">
            ...
            <div className="bg-white rounded-2xl  shadow-[0px_9px_50px_1px_#3DB0F733] w-full max-w-md sm:min-w-[400px] md:min-w-[500px] lg:min-w-[600px] max-sm:p-4 p-8 mx-auto">
                ...
                <h2 className="text-2xl font-semibold text-center mb-2 max-sm:text-[18px]">
                    Create Your Account
                </h2>
                <p className="text-gray-400 text-center mb-6 text-[15px] max-sm:text-[12px]">
                    Join us and enjoy a personalized experience across our platform.
                </p>
                ...
                >
                    ...
                    <div className='flex justify-between gap-5 max-sm:block'>
                        <div className="mb-4 w-[100%]">
                            ...
                            <input
                                ...
                                className={`w-full p-3  max-sm:p-2 rounded-lg border ${errors.fname ? 'border-red-500' : 'border-gray-200'} focus:outline-none focus:ring-2 focus:ring-black max-sm:text-sm`}
                            // className={`w-full p-3  max-sm:p-2 rounded-lg border  border-gray-200 focus:outline-none focus:ring-2 focus:ring-black max-sm:text-sm`}
                            />
                        ...
                        <div className="mb-4  w-[100%]">
                            ...
                            <input
                                ...
                                className={`w-full p-3  max-sm:p-2 rounded-lg border ${errors.lname ? 'border-red-500' : 'border-gray-200'} focus:outline-none focus:ring-2 focus:ring-black  max-sm:text-sm`}
                            // className={`w-full p-3  max-sm:p-2 rounded-lg border  border-gray-200 focus:outline-none focus:ring-2 focus:ring-black max-sm:text-sm`}
                            />
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className={`w-full p-3 max-sm:p-2 rounded-lg border ${errors.email ? 'border-red-500' : 'border-gray-200'} focus:outline-none focus:ring-2  max-sm:text-sm focus:ring-black`}
                        // className={`w-full p-3  max-sm:p-2 rounded-lg border  border-gray-200 focus:outline-none focus:ring-2 focus:ring-black max-sm:text-sm`}
                        />
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            maxLength={10}
                            minLength={10}
                            className={`w-full p-3 max-sm:p-2  max-sm:text-sm rounded-lg border ${errors.mobile ? 'border-red-500' : 'border-gray-200'} focus:outline-none focus:ring-2 focus:ring-black`}
                        // className={`w-full p-3  max-sm:p-2 rounded-lg border  border-gray-200 focus:outline-none focus:ring-2 focus:ring-black max-sm:text-sm`}
                        />
                    ...
                    <div className="mb-4 relative">
                        ...
                        <input
                            ...
                            className={`w-full p-3 max-sm:p-2  max-sm:text-sm rounded-lg border ${errors.password ? 'border-red-500' : 'border-gray-200'} focus:outline-none focus:ring-2 focus:ring-black`}
                        // className={`w-full p-3  max-sm:p-2 rounded-lg border  border-gray-200 focus:outline-none focus:ring-2 focus:ring-black max-sm:text-sm`}
                        />
                        <svg
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className={`w-full p-3 max-sm:p-2  max-sm:text-sm rounded-lg border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-200'} focus:outline-none focus:ring-2 focus:ring-black`}
                        // className={`w-full p-3  max-sm:p-2 rounded-lg border  border-gray-200 focus:outline-none focus:ring-2 focus:ring-black max-sm:text-sm`}
                        />
                    ...
                    <div className="flex justify-center pt-[30px] max-sm:pt-[15px] mx-auto">
                        <button type="submit" className="w-full py-3 bg-black text-white rounded-lg transition duration-200">
                            Create Account
                        </button>
                    </div>
                </form>
                ...
                <p className="text-sm text-center mt-6">
                    ...
                    <Link to="/login" title='Login' className="text-primary hover:underline">
                        Sign in
                    </Link>
                </p>
            </div>
