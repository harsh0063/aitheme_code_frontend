                        ...
                        <div className="w-full">
                            <div className="border w-full order-1 max-xl:order-2 rounded-[10px] max-sm:p-[20px] p-[30px] border-[#D8D8D8]">
                                <div className="flex items-center pb-[20px] justify-between w-full">
                                    ...
                                    <button className="h-[37px] w-[74px] bg-[#E4E4E4] rounded-[3px] robo font-[500] text-[#8E8E8E]">Edit</button>
                                </div>

                                <ul className="pop space-y-[10px]">
                                    <li className="font-light pop max-sm:text-sm">
                                        <span className="font-[500] pop">Name : </span> Jane Doe
                                    </li>
                                    <li className="font-light pop max-sm:text-sm">
                                        <span className="font-[500] pop">Company Name :</span> AI Theme Code
                                    </li>
                                    <li className="font-light pop max-sm:text-sm">
                                        <span className="font-[500] pop">Address :</span> Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                    </li>
                                    <li className="font-light pop max-sm:text-sm">
                                        <span className="font-[500] pop">Email Address  :</span> example@gmail.com
                                    </li>
                                    <li className="font-light pop max-sm:text-sm">
                                        <span className="font-[500] pop">Phone Number : </span> +91 12345 67894
                                    </li>
                                    <li className="font-light pop max-sm:text-sm">
                                        <span className="font-[500] pop">GSTIN : </span> 22AAAAA2222A0Z5
                                    </li>
                                </ul>
                            ...
                            <button className="leading-[54px] flex items-center gap-[22px] max-md:gap-[10px] justify-center max-md:leading-[44px] max-sm:leading-[38px] max-sm:text-[16px]  w-full bg-[#009CDE] shadow-[0px_3px_0px_0px_#038CC5] text-[18px] pop font-[600] mt-[30px] text-white rounded-[3px]">
