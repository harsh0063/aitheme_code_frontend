                ...
                <section>
                    <div className='container'>
                        <div className='flex justify-center mt-[50px] pb-[50px]'>
                            <div>
                                <img src={group} className='w-[90%] mx-auto' alt="" />

                                <div >
                                    <h3 className='font-[500] text-[46px] max-sm:text-[30px] max-md:leading-[40px] my-[20px] text-center  leading-[111.1px] max-md:text-[40px]'>Uh-oh, your cart is empty!</h3>
                                    <p className='pop max-sm:text-[18px] max-sm:leading-[45px]  text-[25px] leading-[55px] text-[#9F9F9F] mt-[-15px] text-center'>Empty cart  vibes</p>
                                    <p className='pop max-sm:text-[18px] max-sm:leading-[45px]  text-[25px] leading-[55px] text-[#9F9F9F] mt-[-15px] text-center'>Time to bring in the shopping joy!</p>
                                    <div className="relative flex justify-center ">
                                        <button onClick={() => navigate('/themes')} className="flex max-sm:text-[20px] max-sm:py-[8px]  mt-[20px] items-center gap-2 absolute  bg-black text-white font-[400] text-[21px] leading-[24px] px-[28px] py-[10px] rounded-[8px]">
                                            <div>
